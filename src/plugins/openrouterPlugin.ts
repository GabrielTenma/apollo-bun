...
class OpenRouterFacade {
  ...
  async createChatCompletion(
    ...
    console.log(`OpenRouter chat completion → model: ${options.model ?? this.defaultModel}`);
...
export interface OpenRouterPluginContext {
  ...
  chat:                  (prompt: string, model?: string, systemPrompt?: string) => Promise<string>;
}

export const openrouterPlugin = new Elysia<OpenRouterPluginContext>({ name: 'OpenRouter' })
  .decorate('createChatCompletion', openRouter.createChatCompletion.bind(openRouter))
